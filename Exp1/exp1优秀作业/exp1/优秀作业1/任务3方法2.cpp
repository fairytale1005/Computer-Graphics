...
void display()
{
	...
	glTranslatef(-2.75, 0.5, 0.0);//按重叠顺序绘制的
	glColor3f(0.0, 0.42, 0.69);
	for (float i = 0; i < 14 * Pi / 8; i += Pi / 100)
	{
		glBegin(GL_POLYGON);
	...
	for (float i = 0; i < 10 * Pi / 8; i += Pi / 100)
	{
		glBegin(GL_POLYGON);
		glVertex3f(r * cos(i), r * sin(i), 0.0);
		glVertex3f(r * cos(i + 2 * Pi / 100), r * sin(i + 2 * Pi / 100), 0.0);
	...
	for (float i = 12 * Pi / 8; i < 14 * Pi / 8; i += Pi / 100)
	{
		glBegin(GL_POLYGON);
		glVertex3f(r * cos(i), r * sin(i), 0.0);
		glVertex3f(r * cos(i + 2 * Pi / 100), r * sin(i + 2 * Pi / 100), 0.0);
	...
	for (float i = 12 * Pi / 8; i < 2 * Pi; i += Pi / 100)
	{
		glBegin(GL_POLYGON);
		glVertex3f(r * cos(i), r * sin(i), 0.0);
		glVertex3f(r * cos(i + 2 * Pi / 100), r * sin(i + 2 * Pi / 100), 0.0);
